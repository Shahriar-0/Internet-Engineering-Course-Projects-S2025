            ...
            <section className="container row mb-5">
                <div className="col-12">
                    <div className="shadow rounded-3 p-3">
                        <p className="fw-bold fs-3 flex align-items-center">
                        ...
                        <button onClick={purchase} className="btn w-100 w-md-auto ms-auto green-btn d-block mx-auto fs-5">Purchase</button>
                    </div>
                </div>
